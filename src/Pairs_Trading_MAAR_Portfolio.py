...
if __name__ == '__main__':
	...
	Pairs_Trading_MAAR_Portfolio(holdings = ['QQQ','QQQM'], price_starting_date = '2015-01-01')
	Pairs_Trading_MAAR_Portfolio(holdings = ["VIXY","VXX"], price_starting_date = '2015-01-01')
